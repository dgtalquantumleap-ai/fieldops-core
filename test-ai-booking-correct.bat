...
curl -X POST http://localhost:3000/api/booking/book ^
  ...
  -d "{\"name\": \"Sarah Johnson\", \"phone\": \"555-123-4567\", \"email\": \"sarah@example.com\", \"service\": \"Standard Cleaning\", \"date\": \"2026-02-17\", \"time\": \"10:00\", \"address\": \"789 Business Ave, Suite 200\"}"
echo.
echo.
